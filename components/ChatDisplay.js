...
const ChatDisplay = ({chat, sender, sgUser, user}) => {
  return (
    ...
    {!sender ? (
        ...
        {sender && chat.read == true && (<Image className='rounded-full self-end' source={{uri: user.profile_picture}} style={{width: 12, height: 12}} />)}
          </View>
